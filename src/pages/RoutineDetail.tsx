...
export function RoutineDetail() {
  ...
  return (
    <div className="anim-rise pb-28">
          ...
          return (
            ...
            >
              ...
              <span className="font-mono text-[12px] text-earth-muted">
                {sets} × {ex.repRange && ex.repRange !== '-' ? ex.repRange : ex.workingSets || '—'}
              </span>
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 mx-auto max-w-md bg-gradient-to-t from-black from-60% to-transparent px-5 pb-6 pt-8">
